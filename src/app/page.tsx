                ...
                <div className="rounded-xl border border-hairline bg-surface p-6">
                  ...
                  <div className="flex flex-col gap-3">
                    <a
                      ...
                      className="flex items-center gap-3 rounded-md border border-hairline bg-surface-elevated px-4 py-3 text-body transition-all hover:border-hairline-strong hover:bg-surface"
                    >

...
export default function LandingPage() {
  ...
  return (
        ...
        <div className="w-full max-w-[1240px] px-6">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="hero-sub mt-5 max-w-[480px] text-[17px] leading-[1.65] text-[#a8a29e] opacity-0">
    ...
    {/* ── Features ── */}
    <section ref={featuresRef} id="features" className="bg-[#0c0a09] px-6 py-[var(--spacing-section)]">
      <div className="mx-auto max-w-[1240px]">
        <FadeIn>
          <div className="mb-10 text-center">
            <h2 className="hero-display mt-2 text-[#fafaf9]">Built for clarity</h2>
            <p className="mt-3 max-w-[520px] mx-auto text-[17px] text-[#a8a29e]">
        ...
        <StaggerChildren gap={0.08} className="grid gap-6 md:grid-cols-3">
          {FEATURES.map((f) => (
            <TiltCard key={f.title} intensity={12} className="h-full">
              <div
                className="flex h-full flex-col rounded-lg border border-[#3c3835] bg-[#181613] p-6"
              ...
              >
                ...
                <h3 className="text-[17px] font-medium text-[#e7e5e4]">{f.title}</h3>
                <p className="mt-2 flex-1 text-[15px] text-[#a8a29e]">{f.description}</p>
                <div className="mt-5 flex items-center gap-2">
                  <span className="h-1 w-6 rounded-full" style={{ background: f.color, opacity: 0.7 }} />
                  <span className="text-[12px] text-[#71717a]">Core feature</span>
                </div>
              </div>
            </TiltCard>
          ))}
    ...
    {/* ── CTA band ── */}
    <section className="bg-[#0c0a09] px-6 py-[var(--spacing-section)]">
      <FadeIn>
        <div className="mx-auto max-w-[720px] text-center">
          <h2 className="hero-display text-[#fafaf9]">
            Ready to separate your audio?
          </h2>
          <p className="mt-4 text-[17px] text-[#a8a29e]">
      ...
      <div className="mx-auto max-w-[1240px]">
        <FadeIn>
          <div className="grid items-start gap-10 lg:grid-cols-2">
            <div>
              <p className="mb-2 text-[12px] text-[#71717a]">About the creator</p>
              <h2 className="hero-display text-[#fafaf9]">
                Hi there, I&apos;m{" "}
                <span style={{ color: "#57c1ff" }}>Shubham</span>
              </h2>
              <p className="mt-4 text-[17px] leading-[1.65] text-[#a8a29e]">
            ...
            <TiltCard intensity={10} className="h-full">
              <div className="rounded-2xl border border-[#3c3835] bg-[#181613] p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_4px_24px_rgba(0,0,0,0.3)]">
                <p className="mb-4 text-[15px] font-medium text-[#e7e5e4]">Connect with me</p>
                <div className="flex flex-col gap-2.5">
                  <a
                    href="https://github.com/Shubhtistic"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 rounded-lg border border-[#3c3835] bg-[#242120] px-4 py-3 text-[#a8a29e] transition-all hover:border-[#4a4541] hover:bg-[#181613]"
                  >
